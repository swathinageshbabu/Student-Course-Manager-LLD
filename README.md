...
Java Development Kit (JDK) - Version 26 is defined in project settings, but Java 17 or higher should suffice.
...
Manual Compilation & Execution: If you prefer to run the commands manually:
